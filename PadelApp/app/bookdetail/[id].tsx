...
export default function BookDetail() {
  ...
  const handleBooking = async () => {
    ...
    try {
      ...
      Alert.alert(
        "Succes",
        `U heeft met succes op ${selectedDateStr} om ${selectedSlot} een veld geboekt bij ${club?.name}`,
        [
                  ...
                  {Array.from({ length: (club.close === 0 ? 24 : club.close) - club.open }, (_, i) => {
                    ...
                    return (
                      <TouchableOpacity
                        ...
                        style={[styles.slot, isDisabled && styles.booked, isSelected && styles.selected]}
                      >
                        <Text style={[styles.slotText, isSelected && styles.whiteText, isDisabled && styles.grayText]}>
                          {slot}
                        </Text>
                      </TouchableOpacity>
                    );
...
const styles = StyleSheet.create({
  ...
  paymentContainer: { backgroundColor: "#f8f9fa", padding: 15, borderRadius: 12, borderWidth: 1, borderColor: "#eee", marginBottom: 20 },
  input: { backgroundColor: "#fff", padding: 14, borderRadius: 8, borderWidth: 1, borderColor: "#ddd", marginBottom: 10, color: "#000" },
  row: { flexDirection: "row" },
  bookBtn: { backgroundColor: "#4CAF50", padding: 18, borderRadius: 12, alignItems: "center", marginTop: 10, marginBottom: 40 },
